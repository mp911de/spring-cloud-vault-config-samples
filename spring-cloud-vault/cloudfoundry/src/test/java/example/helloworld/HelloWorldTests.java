...
public class HelloWorldTests {
	...
	@Test
	public void shouldHaveTokenClientAuthenticationBean() {
		assertThat(applicationContext.getBean(ClientAuthentication.class))
				.isInstanceOf(TokenAuthentication.class);
	}

	@Test
	public void shouldHaveVaultConfigurerBean() {
		assertThat(applicationContext.getBean(VaultConfigurer.class)).isNotNull();
	}
	...
	public void environmentShouldContainProperties() {
		...
		assertThat(environment.getProperty("space-key")).isEqualTo("hello-world-space");
